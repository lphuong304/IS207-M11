...
<head>
	...
	<title>IS207.M11 - Nguyễn Ngọc Lan Phương - 19520227 - Bài tập thực hành Tuần 1</title>

	<link rel="shortcut icon" href="https://en.uit.edu.vn/sites/vi/files/favicon.ico" type="image/vnd.microsoft.icon" />

    <meta name="viewport" content="width=device-width, initial-scale=1">

	<meta content="IS207.M11 - Nguyễn Ngọc Lan Phương- 19520227 - Bài tập thực hành Tuần 1" name="description">
...
<body>
	...
	<div class="container">
		...
		<h2>Bài tập thực hành Tuần 1</h2>
		...
		<table class="table table-hover">
			...
			<tbody>
				...
				<?php
					...
					foreach (array_filter(glob('*'), 'is_dir') as $folder) {

						echo '<tr><td>'.$k.'</td>';

						echo '<td>BÃ i '.$k.'</td>';

						echo '<td><a href="'.$url_root.$folder.'">'.$folder.'</a></td></tr>';
